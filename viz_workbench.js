(function(){
  ...
  function updateSliderVisibility() {
    ...
    var sliderConfig = {
      ...
      "connected": ["basic-sliders"],
      "violin": ["basic-sliders", "jitter-sliders"],
      "hexbin": ["basic-sliders", "grid-sliders"],
      "surface3d": ["basic-sliders", "simulation-sliders"],
      "ridge": ["basic-sliders", "grid-sliders"],
      "hist": ["basic-sliders"],
      "hist2d": ["grid-sliders"],
      "density": ["grid-sliders"],
      "contour": ["basic-sliders", "grid-sliders"],
      "streamlines": ["basic-sliders", "grid-sliders", "art-sliders"],
      "poincare": ["basic-sliders", "jitter-sliders"],
      "poincare-ellipse": ["basic-sliders"],
      "poincare-lag": ["basic-sliders", "lag-sliders"],
      ...
      "art-halftone": ["basic-sliders", "jitter-sliders", "art-sliders"],
